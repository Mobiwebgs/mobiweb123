! function(e) {
    ...
    i.p = "//static.hsappstatic.net/conversations-embed/static-1.15253/";
    i(i.s = 0)
}([function(e, t, i) {
    "use strict";
    var s = i(1);
    (0, i(87).markStartPreDelay)();
    const n = () => {
        (0, s.startOnceReady)();
    ...
    function _(e) {
        ...
        if ((0, d.getExternalApiSettings)().loadImmediately) E({
            logError: e
        });
        else {
    ...
    class J {
        constructor(e, t, i) {
            ...
            this.handleDragEnd = () => {
                ...
                if (a || o)(0, l.setCookie)(i, JSON.stringify({
                    bottom: o,
                    horizontal: a
            ...
            this.initalizeDrag = () => {
                ...
                if (!t || !t["Conversations:DraggableChat"] || (0, n.isAnyMobile)()) return;
                ...
                this.dragHandleEl.style.setProperty(i, "76px");
                this.dragHandleEl.style.setProperty("cursor", "grab");
            ...
            this.getStartPosition = () => {
                if (!this.widgetData.gates || !this.widgetData.gates["Conversations:DraggableChat"] || (0, n.isAnyMobile)()) return null;
            ...
            this.loadIFrame = () => {
                ...
                const t = document.getElementById(v.PARENT_ID) || document.createElement("div");
                t.id = v.PARENT_ID;
            ...
            this.clampPosition = () => {
                ...
                if (!e || !e["Conversations:DraggableChat"] || (0, n.isAnyMobile)()) return;
                let t = !1;
            ...
            this.requestWidgetRefresh = (0, P.throttle)(this.requestWidgetRefresh.bind(this), 1e3);
            ...
            this.eventEmitter = i || new y.default;
            this.logError = t ? t.logError : Z;
        ...
        handleExternalApiEventMessage(e) {
            (0, S.handleExternalApiEventMessage)(e, {
        ...
        removeIframe() {
            this.unintializeDrag();
            const e = (0, M.shouldEmbedInline)() ? document.getElementById(v.INLINE_PARENT_ID) : document.getElementById(v.PARENT_ID);
            e && e.remove();
            this.iframeSrc = null;
            this.hasLoadedIframe = !1;
            this.isLoadingIframe = !1
        ...
        handleStoreMessagesCookie({
            ...
            "yes" === (0, z.getGlobalCookieOptOut)() && this.widgetData.gdprConsentOptions.cookieConsentPrompt !== X.NEVER && window._hsp.push(["showBanner"]);
        ...
        handleWidgetRefresh(e) {
            this.setWidgetData(e);
            (0, d.getWidgetDataResponseType)(this.widgetData) === f.HIDE_WIDGET ? this.removeIframe() : this.iframeMessage.post(r.REFRESH_WIDGET_DATA, Object.assign({}, this.widgetData, {}, (0, R.getIframeQueryParams)(this.embedScriptContext)))
        }
        setWidgetNotLoaded() {
            this.hasLoadedIframe = !1;
            this.isLoadingIframe = !1
        ...
        var T = I(i),
            b = {
                apple: {
                    phone: T(s) && !T(u),
                    ipod: T(n),
                    tablet: !T(s) && (T(o) || _(t)) && !T(u),
                    universal: T(r),
                    device: (T(s) || T(n) || T(o) || T(r) || _(t)) && !T(u)
                },
                amazon: {
                    phone: T(d),
                    tablet: !T(d) && T(l),
                ...
                android: {
                    phone: !T(u) && T(d) || !T(u) && T(a),
                    tablet: !T(u) && !T(d) && !T(a) && (T(l) || T(c)),
                    device: !T(u) && (T(d) || T(l) || T(a) || T(c)) || T(/\bokhttp\b/i)
                },
                windows: {
                    phone: T(u),
                    tablet: T(h),
                ...
                other: {
                    ...
                    firefox: T(E),
                    chrome: T(m),
                    device: T(g) || T(p) || T(f) || T(E) || T(m)
                },
                any: !1,
                phone: !1,
                tablet: !1
            };
        b.any = b.apple.device || b.android.device || b.windows.device || b.other.device;
    ...
    const r = "open-change";
    t.OPEN_CHANGE = r;
    const a = "closed-welcome-message";
    t.CLOSED_WELCOME_MESSAGE = a;
    ...
    function l({
        ...
        const l = -1 !== i.indexOf(d) && !a.test(i),
            u = c.test(i);
        return !(!r.test(t) || l || u) && (-1 !== t.indexOf("qa") ? e === s || e === n || e === o : e === s)
    }
}, function(e, t, i) {
    "use strict";
    Object.defineProperty(t, "__esModule", {
    ...
    const a = ({
        ...
        const i = (0, n.isEmbeddedInProduct)({
                portalId: e
            }) && !t,
    ...
    const l = () => (0, s.getExternalApiSettings)().enableWidgetCookieBanner;
    ...
    const r = "hubspot-conversations-iframe";
    t.IFRAME_ID = r
}, function(e, t, i) {
    "use strict";
    Object.defineProperty(t, "__esModule", {
                ...
                Object.create && (o.prototype = Object.create(null), (new o).__proto__ || (n = !1)), d.prototype.eventNames = function() {
                    ...
                    if (l.fn) {
                        switch (l.once && this.removeListener(e, l.fn, void 0, !0), u) {
                            ...
                            case 4:
                                return l.fn.call(l.context, t, i, s), !0;
                            case 5:
                                return l.fn.call(l.context, t, i, s, o), !0;
                            case 6:
                                return l.fn.call(l.context, t, i, s, o, r), !0
                        }
                        for (d = 1, c = new Array(u - 1); d < u; d++) c[d - 1] = arguments[d];
                        l.fn.apply(l.context, c)
                    } else {
                        var h, g = l.length;
                        for (d = 0; d < g; d++) switch (l[d].once && this.removeListener(e, l[d].fn, void 0, !0), u) {
                            case 1:
                    ...
                    if (r.fn) r.fn !== t || s && !r.once || i && r.context !== i || c(this, o);
                    else {
                        for (var a = 0, d = [], l = r.length; a < l; a++)(r[a].fn !== t || s && !r[a].once || i && r[a].context !== i) && d.push(r[a]);
    ...
    t.USER_SELECTED_THREAD = t.WIDGET_CLOSED = t.WIDGET_LOADED = t.QUICK_REPLY_BUTTON_CLICK = t.USER_INTERACTED_WITH_WIDGET = t.CONTACT_ASSOCIATED = t.INPUT_STAGING = t.UNREAD_CONVERSATION_COUNT_CHANGED = t.CONVERSATION_CLOSED = t.CONVERSATION_STARTED = void 0;
    ...
    const o = "X-HubSpot-Messages-Uri",
        r = 4,
        a = [200, 304];
    t.WIDGET_WILL_LOAD_CODES = a;
    const c = [204, 404];
    t.EXPECTED_WIDGET_WILL_NOT_LOAD_CODES = c;
    const d = e => a.indexOf(e) > -1,
    ...
    const a = ({
        ...
        return {
            post: (i, r = {}) => {
                const a = (0, s.getIframeFromDocumentQuery)(),
                    c = a && a.contentDocument && "about:blank" === a.contentDocument.URL;
                if (!a || c) t.enqueue({
                    type: i,
                    data: r
                });
    ...
    const o = ({
        ...
        const o = document.getElementById(s.PARENT_ID);
        if ((0, n.isAnyMobile)() && i && o) {
            o.style.width = "100%";
            o.style.height = "100%"
        } else if (e && t && o) {
            o.style.width = t + "px";
    ...
    const l = (e, t, i) => l => {
        ...
        if (u) {
            const {
                ...
                timeDelay: n
            } = (0, r.getDelayLoadingWidgetIframe)(l, (0, s.isAnyMobile)());
            (0, c.markEndPreDelay)();
            if (i) setTimeout(() => {
                e(l);
    ...
    function a({
        ...
        return `${(0,n.getApiDomain)(e,s)}/livechat/v1/message/public/hubspot-app?portalId=${a}&mobile=${(0,r.isAnyMobile)()}&embeddedPortalId=${t}&traceId=${i}`
    }
    ...
    function c({
        ...
        let l = `?portalId=${i}&${s.bender.project}=${s.bender.depVersions[s.bender.project]}&mobile=${(0,r.isAnyMobile)()}`;
    ...
    function l({
        ...
        return `${(0,n.getApiDomain)(t,e)}/livechat-public/v1/message/public${c({messagesUtk:i,hubspotUtk:s,portalId:o,referrer:r,hstc:a,hssc:d,email:l,identificationToken:u})}`
    }
}, function(e, t) {
    e.exports = {
        mode: "compressed",
        ...
        bender: {
            depVersions: {
                "conversations-embed": "static-1.15253",
                "browserslist-config-hubspot": "static-1.87",
                classnames: "static-2.10",
                "conversations-internal-schema": "static-1.8253",
                csstype: "static-1.8",
                cssUtils: "static-1.283",
                enviro: "static-4.127",
                "hds-components": "static-1.598",
                "hds-tokens": "static-1.171",
                "head-dlb": "static-1.368",
                HeadJS: "static-2.376",
                "hoist-non-react-statics": "static-3.9",
                "hs-story-utils": "static-1.2178",
                "hubspot-url-utils": "static-1.185",
                HubStyle: "static-2.5939",
                HubStyleTokens: "static-2.5629",
                I18n: "static-7.1038",
                "i18n-data": "static-1.147",
                icons: "static-2.561",
                immutable: "static-2.19",
                isMobile: "static-1.7",
                jasmine: "static-4.97",
                "jasmine-runner": "static-1.595",
                "metrics-js": "static-1.3512",
                ...
                "react-utils": "static-2.1018",
                "react-virtualized": "static-2.26",
                sassPrefix: "static-1.88",
                sinon: "static-1.9",
                "styled-components": "static-2.27",
                StyleGuideUI: "static-3.371",
                transmute: "static-2.29",
                "ui-fonts": "static-1.313",
                "ui-images": "static-2.620",
                UIComponents: "static-3.2580",
            ...
            depPathPrefixes: {
                "conversations-embed": "/conversations-embed/static-1.15253",
                "browserslist-config-hubspot": "/browserslist-config-hubspot/static-1.87",
                classnames: "/classnames/static-2.10",
                "conversations-internal-schema": "/conversations-internal-schema/static-1.8253",
                csstype: "/csstype/static-1.8",
                cssUtils: "/cssUtils/static-1.283",
                enviro: "/enviro/static-4.127",
                "hds-components": "/hds-components/static-1.598",
                "hds-tokens": "/hds-tokens/static-1.171",
                "head-dlb": "/head-dlb/static-1.368",
                HeadJS: "/HeadJS/static-2.376",
                "hoist-non-react-statics": "/hoist-non-react-statics/static-3.9",
                "hs-story-utils": "/hs-story-utils/static-1.2178",
                "hubspot-url-utils": "/hubspot-url-utils/static-1.185",
                HubStyle: "/HubStyle/static-2.5939",
                HubStyleTokens: "/HubStyleTokens/static-2.5629",
                I18n: "/I18n/static-7.1038",
                "i18n-data": "/i18n-data/static-1.147",
                icons: "/icons/static-2.561",
                immutable: "/immutable/static-2.19",
                isMobile: "/isMobile/static-1.7",
                jasmine: "/jasmine/static-4.97",
                "jasmine-runner": "/jasmine-runner/static-1.595",
                "metrics-js": "/metrics-js/static-1.3512",
                "moment-timezone": "/moment-timezone/static-5.17",
                PortalIdParser: "/PortalIdParser/static-2.120",
                quartz: "/quartz/static-1.898",
                react: "/react/static-7.96",
                "react-dom": "/react-dom/static-7.62",
                "react-input-autosize": "/react-input-autosize/static-2.17",
                "react-select-plus": "/react-select-plus/static-1.41",
                "react-utils": "/react-utils/static-2.1018",
                "react-virtualized": "/react-virtualized/static-2.26",
                sassPrefix: "/sassPrefix/static-1.88",
                sinon: "/sinon/static-1.9",
                "styled-components": "/styled-components/static-2.27",
                StyleGuideUI: "/StyleGuideUI/static-3.371",
                transmute: "/transmute/static-2.29",
                "ui-fonts": "/ui-fonts/static-1.313",
                "ui-images": "/ui-images/static-2.620",
                UIComponents: "/UIComponents/static-3.2580",
    ...
    function a({
        ...
        try {
            ...
            const e = performance.getEntriesByName(s.EXECUTION_MEASUREMENT_PRE_DELAY)[0],
                t = performance.getEntriesByName(s.EXECUTION_MEASUREMENT_POST_DELAY)[0],
                i = e.duration + t.duration,
    ...
    function s(e) {
        return ["function" == typeof e.WeakMap, "function" == typeof e.requestAnimationFrame, "function" == typeof e.URLSearchParams].every(e => e)
    }
}, function(e, t, i) {
    "use strict";
    Object.defineProperty(t, "__esModule", {
...
//# sourceMappingURL=//static.hsappstatic.net/conversations-embed/static-1.15253/bundles/project.js.map