...
_hsp.push(['addCookieDomain', '.successive.tech']);
...
! function(e) {
    ...
    n.p = "//static.hsappstatic.net/cookie-banner-js/static-1.1671/";
    n(n.s = 4)
}([function(e, t, n) {
    var o;
    ...
    s.prototype.clean_node = function(e) {
        ...
        function a(e) {
            var t, i, a, l, h, d, u, _, f, g, m = c.call(this, e);
                ...
                for (t = 0; t < l.length; t++) {
                    ...
                    if (h = e.attributes[d]) {
                        ...
                        if (this.config.protocols[a] && this.config.protocols[a][d]) {
                            _ = this.config.protocols[a][d];
                            g = (f = h.value.toLowerCase().match(s.REGEX_PROTOCOL)) ? -1 != n(f[1], _) : -1 != n(s.RELATIVE, _)
                        }
                        if (g) {
    ...
    var g = /^\s*at (?:((?:\[object object\])?[^\\/]+(?: \[as \S+\])?) )?\(?(.*?):(\d+)(?::(\d+))?\)?\s*$/i;
    ...
    const E = [0, 0, 0],
        I = e => e.some(e => e > 0),
        L = (e, t) => (e.map((e, n) => e - t[n]).find(e => 0 !== e) || 0) >= 0;
    class N {
        constructor(e = "", t = [], n = []) {
        ...
        test(e, t, n) {
            ...
            if (!e.startsWith(this.targetedPathPrefix)) return E;
    ...
    A.TOP = new A(0);
    A.BOTTOM = new A(1);
    A.BOTTOM_LEFT = new A(2);
    A.BOTTOM_RIGHT = new A(3);
    A.CENTER = new A(4);
    class B {
        constructor(e, t, n) {
            this.position = e;
    ...
    const D = new R.a({
            ...
            protocols: {
                a: {
                    href: ["http", "https", "mailto", R.a.ALL]
                },
                blockquote: {
                    cite: ["http", "https", R.a.RELATIVE]
                },
                q: {
                    cite: ["http", "https", R.a.RELATIVE]
                }
        ...
        U = e => {
            ...
            try {
                ...
                O.error("we had an error sanitizing an html string: " + e)
            }
            return t.innerHTML
        },
        G = e => ({
    ...
    class M {
        ...
        static fromJS(e) {
            return new M(e.description, e.label, e.toggleLabel)
        }
        getSanitizedText() {
            return new M(U(this.description), U(this.label), U(this.toggleLabel))
        }
    }
    class Y {
        ...
        static fromJS(e) {
            return new Y(e.acceptAllLabel, e.saveSettingsLabel, M.fromJS(e.introduction), M.fromJS(e.categories.necessary), M.fromJS(e.categories.analytics), M.fromJS(e.categories.advertisement), M.fromJS(e.categories.functionality))
        }
        getSanitizedText() {
            return new Y(U(this.acceptLabel), U(this.saveSettingsLabel), this.introduction.getSanitizedText(), this.necessary.getSanitizedText(), this.analytics.getSanitizedText(), this.advertisement.getSanitizedText(), this.functionality.getSanitizedText())
        }
    }
    class F {
        ...
        static fromJS(e) {
            return new F(e.notification, e.acceptLabel, e.declineLabel, e.disclaimer, e.modalText && e.modalText.cookieSettingsLabel, e.modalText && Y.fromJS(e.modalText))
        }
        getSanitizedText() {
            return new F(U(this.notification), U(this.acceptLabel), U(this.declineLabel), U(this.disclaimer), this.cookieSettingsLabel && U(this.cookieSettingsLabel), this.modalText && this.modalText.getSanitizedText())
        }
    }
    class H {
        constructor(e, t) {
    ...
    H.COOKIES_WITHOUT_BANNER = new H(0, "COOKIES_WITHOUT_BANNER");
    H.NO_COOKIES = new H(1, "NO_COOKIES");
    H.NOTIFY = new H(2, "NOTIFY");
    H.OPT_IN = new H(3, "OPT_IN");
    H.COOKIES_BY_CATEGORY = new H(4, "COOKIES_BY_CATEGORY");
    H.OPT_OUT = new H(5, "OPT_OUT");
    H.OPT_OUT_BY_CATEGORY = new H(6, "OPT_OUT_BY_CATEGORY");
    class z {
        constructor(e, t) {
            this.type = e;
            this.text = t
        ...
        static fromJS(e) {
            ...
            return new z(H.fromJS(t), F.fromJS(n))
        }
        getSanitizedPolicy() {
            return new z(this.type, this.text.getSanitizedText())
        }
    }
    class V {
        constructor(e, t) {
            this.enabled = e;
            this.notificationText = U(t || "")
        }
        static fromJS(e) {
            return new V(e.enabled, e.notificationText)
        }
    }
    class $ {
        constructor(e, t, n, o, i, s, r, a, c) {
            this.id = e;
            this.portalId = t;
            this.domain = n;
            this.label = o;
        ...
        static fromJS(e) {
            ...
            return new $(t, n, o, i, s, N.fromJS(r), z.fromJS(a), B.fromJS(c), V.fromJS(l))
        }
        withSanitizedPolicy() {
            return new $(this.id, this.portalId, this.domain, this.label, this.enabled, this.configuration, this.policy.getSanitizedPolicy(), this.customizationSettings, this.gpcSettings)
        }
        toLegacyPrivacyPolicy() {
            let e;
            switch (this.policy.type) {
                case H.COOKIES_WITHOUT_BANNER:
                    e = 0;
                    break;
                case H.NO_COOKIES:
                    e = 2;
                ...
                case H.OPT_IN:
                    e = 1;
                    break;
                case H.OPT_OUT_BY_CATEGORY:
                case H.COOKIES_BY_CATEGORY:
                default:
                    e = 3
            }
            return {
                ...
                hideDecline: this.policy.type === H.NOTIFY,
    ...
    class J {
        ...
        toCookieString() {
            return `${K}:${this.categories.analytics}_${W}:${this.categories.advertisement}_${q}:${this.categories.functionality}`
        }
    ...
    const Q = e => encodeURI(e),
        Z = e => decodeURI(e),
        X = "_fbp",
        ee = "1970-01-01T00:00:01-00:00";
    class te {
        constructor(e) {
            this.context = e;
        ...
        addDomain(e) {
            ("." + this.context.getHostname()).endsWith(e) && (!this.currentDomain || e.length < this.currentDomain.length) && (this.currentDomain = e);
            this.domains.push(e)
        }
        getDomains() {
            return this.domains
    ...
    ne.CATEGORY_PREFERENCE_COOKIE = new ne("__hs_cookie_cat_pref", 180);
    ne.GPC_BANNER_DISMISS_COOKIE = new ne("__hs_gpc_banner_dismiss", 180);
    ne.NOTIFY_BANNER_DIMISS_COOKIE = new ne("__hs_notify_banner_dismiss", 180);
    ne.OPT_OUT_COOKIE = new ne("__hs_opt_out", 180);
    ne.INITIAL_OPT_IN = new ne("__hs_initial_opt_in", 7);
    var oe, ie, se, re, ae, ce, le = {},
        he = [],
    ...
    function fe(e, t, n) {
        ...
        if (arguments.length > 2 && (r.children = arguments.length > 3 ? oe.call(arguments, 2) : n), "function" == typeof e && null != e.defaultProps)
            for (s in e.defaultProps) void 0 === r[s] && (r[s] = e.defaultProps[s]);
        return ge(e, r, o, i, null)
    }
    ...
    function ge(e, t, n, o, i) {
        ...
        return null == i && null != ie.vnode && ie.vnode(s), s
    }
    ...
    function ve(e) {
        (!e.__d && (e.__d = !0) && re.push(e) && !Ce.__r++ || ce !== ie.debounceRendering) && ((ce = ie.debounceRendering) || ae)(Ce)
    }

    function Ce() {
        for (var e; Ce.__r = re.length;) e = re.sort((function(e, t) {
            return e.__v.__b - t.__v.__b
        })), re = [], e.some((function(e) {
            var t, n, o, i, s, r;
            e.__d && (s = (i = (t = e).__v).__e, (r = t.__P) && (n = [], (o = ue({}, i)).__v = i.__v + 1, Le(r, i, o, t.__n, void 0 !== r.ownerSVGElement, null != i.__h ? [s] : null, n, null == s ? be(i) : s, i.__h), Ne(n, i), i.__e != s && ye(i)))
        }))
    }

    function xe(e, t, n, o, i, s, r, a, c, l) {
        var h, d, u, _, f, g, m, p = o && o.__k || he,
            b = p.length;
        for (n.__k = [], h = 0; h < t.length; h++)
            if (null != (_ = n.__k[h] = null == (_ = t[h]) || "boolean" == typeof _ ? null : "string" == typeof _ || "number" == typeof _ || "bigint" == typeof _ ? ge(null, _, null, null, _) : Array.isArray(_) ? ge(me, {
                    children: _
                }, null, null, null) : _.__b > 0 ? ge(_.type, _.props, _.key, null, _.__v) : _)) {
                if (_.__ = n, _.__b = n.__b + 1, null === (u = p[h]) || u && _.key == u.key && _.type === u.type) p[h] = void 0;
                else
                    for (d = 0; d < b; d++) {
                        if ((u = p[d]) && _.key == u.key && _.type === u.type) {
                            p[d] = void 0;
                            break
                        }
                        u = null
                    }
                Le(e, _, u = u || le, i, s, r, a, c, l), f = _.__e, (d = _.ref) && u.ref != d && (m || (m = []), u.ref && m.push(u.ref, null, _), m.push(d, _.__c || f, _)), null != f ? (null == g && (g = f), "function" == typeof _.type && _.__k === u.__k ? _.__d = c = Se(_, c, e) : c = we(e, _, u, p, f, c), "function" == typeof n.type && (n.__d = c)) : c && u.__e == c && c.parentNode != e && (c = be(u))
            }
        for (n.__e = g, h = b; h--;) null != p[h] && ("function" == typeof n.type && null != p[h].__e && p[h].__e == n.__d && (n.__d = be(o, h + 1)), Pe(p[h], p[h]));
        if (m)
            for (h = 0; h < m.length; h++) Be(m[h], m[++h], m[++h])
    }

    function Se(e, t, n) {
        for (var o, i = e.__k, s = 0; i && s < i.length; s++)(o = i[s]) && (o.__ = e, t = "function" == typeof o.type ? Se(o, t, n) : we(n, o, o, i, o.__e, t));
        return t
    }

    function we(e, t, n, o, i, s) {
        var r, a, c;
    ...
    function Te(e, t, n, o, i) {
        var s;
        for (s in n) "children" === s || "key" === s || s in t || Oe(e, s, null, n[s], o);
        for (s in t) i && "function" != typeof t[s] || "children" === s || "key" === s || "value" === s || "checked" === s || n[s] === t[s] || Oe(e, s, t[s], n[s], o)
    }

    function ke(e, t, n) {
        "-" === t[0] ? e.setProperty(t, n) : e[t] = null == n ? "" : "number" != typeof n || de.test(t) ? n : n + "px"
    }
        ...
        e: if ("style" === t)
            if ("string" == typeof n) e.style.cssText = n;
                ...
                if ("string" == typeof o && (e.style.cssText = o = ""), o)
                    for (t in o) n && t in n || ke(e.style, t, "");
                if (n)
                    for (t in n) o && n[t] === o[t] || ke(e.style, t, n[t])
            }
        else if ("o" === t[0] && "n" === t[1]) s = t !== (t = t.replace(/Capture$/, "")), t = t.toLowerCase() in e ? t.toLowerCase().slice(2) : t.slice(2), e.l || (e.l = {}), e.l[t + s] = n, n ? o || e.addEventListener(t, s ? Ie : Ee, s) : e.removeEventListener(t, s ? Ie : Ee, s);
    ...
    function Le(e, t, n, o, i, s, r, a, c) {
        var l, h, d, u, _, f, g, m, p, b, y, v = t.type;
        if (void 0 !== t.constructor) return null;
        null != n.__h && (c = n.__h, a = t.__e = n.__e, t.__h = null, s = [a]), (l = ie.__b) && l(t);
        try {
            e: if ("function" == typeof v) {
                if (m = t.props, p = (l = v.contextType) && o[l.__c], b = l ? p ? p.props.value : l.__ : o, n.__c ? g = (h = t.__c = n.__c).__ = h.__E : ("prototype" in v && v.prototype.render ? t.__c = h = new v(m, b) : (t.__c = h = new pe(m, b), h.constructor = v, h.render = Re), p && p.sub(h), h.props = m, h.state || (h.state = {}), h.context = b, h.__n = o, d = h.__d = !0, h.__h = []), null == h.__s && (h.__s = h.state), null != v.getDerivedStateFromProps && (h.__s == h.state && (h.__s = ue({}, h.__s)), ue(h.__s, v.getDerivedStateFromProps(m, h.__s))), u = h.props, _ = h.state, d) null == v.getDerivedStateFromProps && null != h.componentWillMount && h.componentWillMount(), null != h.componentDidMount && h.__h.push(h.componentDidMount);
                else {
                    ...
                    null != h.componentWillUpdate && h.componentWillUpdate(m, h.__s, b), null != h.componentDidUpdate && h.__h.push((function() {
                        h.componentDidUpdate(u, _, f)
                    }))
                }
                h.context = b, h.props = m, h.state = h.__s, (l = ie.__r) && l(t), h.__d = !1, h.__v = t, h.__P = e, l = h.render(h.props, h.state, h.context), h.state = h.__s, null != h.getChildContext && (o = ue(ue({}, o), h.getChildContext())), d || null == h.getSnapshotBeforeUpdate || (f = h.getSnapshotBeforeUpdate(u, _)), y = null != l && l.type === me && null == l.key ? l.props.children : l, xe(e, Array.isArray(y) ? y : [y], t, n, o, i, s, r, a, c), h.base = t.__e, t.__h = null, h.__h.length && r.push(h), g && (h.__E = h.__ = null), h.__e = !1
            } else null == s && t.__v === n.__v ? (t.__k = n.__k, t.__e = n.__e) : t.__e = Ae(n.__e, t, n, o, i, s, r, c);
            (l = ie.diffed) && l(t)
        }
        catch (e) {
            t.__v = null, (c || null != s) && (t.__e = a, t.__h = !!c, s[s.indexOf(a)] = null), ie.__e(e, t, n)
        }
    }
    ...
    function Ae(e, t, n, o, i, s, r, a) {
        ...
        if ("svg" === _ && (i = !0), null != s)
            for (; f < s.length; f++)
                if ((c = s[f]) && "setAttribute" in c == !!_ && (_ ? c.localName === _ : 3 === c.nodeType)) {
                    e = c, s[f] = null;
                    break
                }
        if (null == e) {
            if (null === _) return document.createTextNode(u);
            e = i ? document.createElementNS("http://www.w3.org/2000/svg", _) : document.createElement(_, u.is && u), s = null, a = !1
        }
        if (null === _) d === u || a && e.data === u || (e.data = u);
        else {
            if (s = s && oe.call(e.childNodes), l = (d = n.props || le).dangerouslySetInnerHTML, h = u.dangerouslySetInnerHTML, !a) {
                if (null != s)
            ...
            if (Te(e, u, d, i, a), h) t.__k = [];
            else if (f = t.props.children, xe(e, Array.isArray(f) ? f : [f], t, n, o, i && "foreignObject" !== _, s, r, s ? s[0] : n.__k && be(n, 0), a), null != s)
                for (f = s.length; f--;) null != s[f] && _e(s[f]);
            a || ("value" in u && void 0 !== (f = u.value) && (f !== e.value || "progress" === _ && !f || "option" === _ && f !== d.value) && Oe(e, "value", f, d.value, !1), "checked" in u && void 0 !== (f = u.checked) && f !== e.checked && Oe(e, "checked", f, d.checked, !1))
        }
        return e
    }
    ...
    function Pe(e, t, n) {
        var o, i;
        if (ie.unmount && ie.unmount(e), (o = e.ref) && (o.current && o.current !== e.__e || Be(o, null, t)), null != (o = e.__c)) {
        ...
        if (o = e.__k)
            for (i = 0; i < o.length; i++) o[i] && Pe(o[i], t, "function" != typeof e.type);
        n || null == e.__e || _e(e.__e), e.__e = e.__d = void 0
    }
    ...
    function De(e, t, n) {
        var o, i, s;
        ie.__ && ie.__(e, t), i = (o = "function" == typeof n) ? null : n && n.__k || t.__k, s = [], Le(t, e = (!o && n || t).__k = fe(me, null, [e]), i || le, le, void 0 !== t.ownerSVGElement, !o && n ? [n] : i ? null : t.firstChild ? oe.call(t.childNodes) : null, s, !o && n ? n : i ? i.__e : t.firstChild, o), Ne(s, e)
    }
    oe = he.slice, ie = {
            __e: function(e, t) {
        ...
        function(e) {
            ...
            var n;
            n = null != this.__s && this.__s !== this.state ? this.__s : this.__s = ue({}, this.state), "function" == typeof e && (e = e(ue({}, n), this.props)), e && ue(n, e), null != e && this.__v && (t && this.__h.push(t), ve(this))
        }, pe.prototype.forceUpdate = function(e) {
            this.__v && (this.__e = !0, e && this.__h.push(e), ve(this))
        }, pe.prototype.render = me, re = [], ae = "function" == typeof Promise ? Promise.prototype.then.bind(Promise.resolve()) : setTimeout, Ce.__r = 0, 0;
    var Ue = 0;
    ...
    function Qe(e, t, n) {
        var o = je(Me++, 2);
        return o.t = e, o.__c || (o.__ = [n ? n(t) : rt(void 0, t), function(e) {
            var t = o.t(o.__[0], e);
    ...
    function Ze(e, t) {
        var n = je(Me++, 3);
        !ie.__s && st(n.__H, t) && (n.__ = e, n.__H = t, Ye.__H.__h.push(n))
    }

    function Xe(e) {
        return He = 5, et((function() {
            return {
                current: e
            }
        }), [])
    ...
    function tt() {
        for (var e; e = ze.shift();)
            if (e.__P) try {
                e.__H.__h.forEach(ot), e.__H.__h.forEach(it), e.__H.__h = []
            } catch (t) {
    ...
    ie.__b = function(e) {
        ...
        $e && $e(e), Me = 0;
        var t = (Ye = e.__c).__H;
        t && (t.__h.forEach(ot), t.__h.forEach(it), t.__h = [])
    }, ie.diffed = function(e) {
        Ke && Ke(e);
        var t = e.__c;
        t && t.__H && t.__H.__h.length && (1 !== ze.push(t) && Fe === ie.requestAnimationFrame || ((Fe = ie.requestAnimationFrame) || function(e) {
            var t, n = function() {
                    clearTimeout(o), nt && cancelAnimationFrame(t), setTimeout(e)
                },
                o = setTimeout(n, 100);
        ...
        t.some((function(e) {
            try {
                e.__h.forEach(ot), e.__h = e.__h.filter((function(e) {
                    return !e.__ || it(e)
                }))
            } catch (n) {
                t.some((function(e) {
    ...
    function lt({
        ...
        const _ = r ? -1 : 0,
            f = i.policy,
            g = i.policy.type,
            m = g === H.OPT_OUT_BY_CATEGORY || g === H.COOKIES_BY_CATEGORY,
            p = g === H.OPT_IN || g === H.OPT_OUT || g === H.OPT_OUT_BY_CATEGORY || g === H.COOKIES_BY_CATEGORY;
        return Ge("div", {
            id: u,
            className: i.customizationSettings.position === A.BOTTOM ? "hs-cookie-notification-position-bottom" : "",
            "data-nosnippet": "true",
            role: "dialog",
            ...
            children: Ge("div", {
                ...
                children: [Ge("div", {
                    ...
                    dangerouslySetInnerHTML: G(f.text.notification),
                    ref: l,
                    tabIndex: _
                }), f.text.disclaimer && p && Ge("p", {
                    id: "hs-eu-cookie-disclaimer",
                    dangerouslySetInnerHTML: G(f.text.disclaimer),
                    tabIndex: _
                }), Ge("div", {
                    id: "hs-eu-cookie-confirmation-buttons-area",
                    children: Ge("div", {
                        id: "hs-eu-confirmation-button-group",
                        children: [m && Ge("button", {
                            onClick: () => n(),
                            id: "hs-eu-cookie-settings-button",
                            dangerouslySetInnerHTML: G(f.text.cookieSettingsLabel),
                            ...
                            children: [Ge("button", {
                                ...
                                onClick: () => t(g),
                                dangerouslySetInnerHTML: G(f.text.acceptLabel),
                                "aria-label": f.text.acceptLabel,
                                ref: h,
                                tabIndex: _
                            }), p && Ge("button", {
                                id: "hs-eu-decline-button",
                                onClick: () => o(),
                                dangerouslySetInnerHTML: G(f.text.declineLabel),
                                ref: d,
                                "aria-label": f.text.declineLabel,
                                tabIndex: _
                            })]
                        })]
                    })
    ...
    function _t({
        ...
        const [s, r] = Je(!1), a = e === p.NECESSARY, c = Xe(null), l = Xe(null), h = () => {
            r(!s)
        };
        Ze(() => {
            if (s) {
                const e = c.current;
                e && e.scrollIntoView && !ut(e, i.current) && e.scrollIntoView({
                    behavior: "smooth"
                })
            }
        }, [s, i, c]);
            ...
            children: [Ge("div", {
                ...
                children: [Ge("button", {
                    ...
                    children: [Ge(dt, {
                        ...
                        dangerouslySetInnerHTML: G(n.label)
                    })]
                }), !a && Ge(ht, {
                    category: e,
                    ...
                    toggleValue: o
                }), n.toggleLabel && Ge("span", {
                    className: "hs-always-active-label",
                    dangerouslySetInnerHTML: G(n.toggleLabel),
                    tabIndex: 0,
                ...
                dangerouslySetInnerHTML: G(n.description),
                tabIndex: 0
            })]
        })
    }
    ...
    function Ct({
        ...
        const r = Xe(null),
            ...
            l = Xe(null);
        Ze(() => {
            r.current && ct(n, r.current, a.current, c.current)
        }, [n, r, a, c]);
        const [h, d] = Je(t.categories.analytics), [u, _] = Je(t.categories.advertisement), [f, b] = Je(t.categories.functionality), y = () => {
            i({
                [p.ANALYTICS]: h,
                [p.ADVERTISEMENT]: u,
                [p.FUNCTIONALITY]: f
                ...
                children: [Ge("div", {
                    ...
                    children: Ge("div", {
                        ...
                        children: [Ge("div", {
                            ...
                            children: Ge("span", {
                                dangerouslySetInnerHTML: G(o.introduction.label)
                            })
                        }), Ge("div", {
                            id: "hs-modal-introduction-description",
                            children: Ge("p", {
                                dangerouslySetInnerHTML: G(o.introduction.description)
                            })
                        }), Ge("div", {
    ...
    function xt({
        ...
        const [a, c] = Je(!1), l = e => {
            ...
            if (e !== H.OPT_IN && e !== H.COOKIES_BY_CATEGORY)
                if (e !== H.NOTIFY) {
                    t.update(!0);
                    i(t)
                } else r();
        ...
        yt(o, n.customizationSettings.accentColor, e);
        return Ge(me, {
            children: [Ge(lt, {
                context: o,
                setting: n,
    ...
    function St({
        ...
        yt(t, n.customizationSettings.accentColor, e);
        return Ge("div", {
            id: _,
            "data-nosnippet": "true",
            role: "dialog",
            ...
            children: Ge("div", {
                ...
                children: [Ge("div", {
                    ...
                    dangerouslySetInnerHTML: G(n.gpcSettings.notificationText)
                })]
            })
        })
    }
    ...
    class Ot {
        static postActivity(e, t, n) {
            ...
            }).then(() => O.info(`Sent a banner ${t} event.`)).catch(() => O.error(`There was an issue sending a banner ${t} event.`))
        }
        static sendView(e, t) {
            Ot.postActivity(e + "/activity/view", "VIEW", t)
        }
        static sendClick(e, t) {
            Ot.postActivity(e + "/activity/click", "CLICK", t)
        }
    }
    let Et;
    ! function(e) {
    ...
    const It = {
        ...
        Dt = (e, t) => Nt(t) ? [] : [...At(`--hs-banner-${e}-color`, t.color), ...At(`--hs-banner-${e}-text-color`, t.textColor), ...At(`--hs-banner-${e}-border-color`, t.borderColor)],
        Ut = e => Nt(e) ? [] : [{
    ...
    class zt {
        constructor(e) {
            this.publicMethods = ["showBanner", "hideBanner", "addPrivacyConsentListener", "setApiBaseUrl", "setCookiesToSubdomain", "setUseSecureCookies", "addCookieDomain", "addEnabledFeatureGates", "setBannerSettings", "setCustomizationSettings", "setUseGeoLocation", "setGeoLocation", "addPrivacySettingsListener", "revokeCookieConsent"];
            ...
            this.cookie = new te(e);
            this.isRunningInTestMode = e.getLocation().search.includes(d);
            this.removeDeprecatedBannerCookies()
        }
        removeDeprecatedBannerCookies() {
            this.cookie.get(ne.OPT_OUT_COOKIE.getName()) && this.cookie.remove(ne.OPT_OUT_COOKIE.getName());
            this.cookie.get(ne.INITIAL_OPT_IN.getName()) && this.cookie.remove(ne.INITIAL_OPT_IN.getName())
        }
        run() {
            if (this.disableBannerFlagSet()) {
                O.info('"PRIVACY" flag found in disabledHsPopups window queue. Banner script will not run.');
                return !0
            }
            this.findMatchingSetting();
            this.logGpcSignal();
            if (!this.matchedSetting) {
                O.debug("we were unable to find the matching settings for this webpages. The banner will not run.");
                this.setConsent(new J(!0), {
                    reportClick: !1
                });
                return !1
            }
            ...
            switch (this.matchedSetting.policy.type) {
                ...
                case H.COOKIES_BY_CATEGORY:
                    ...
                    this.setConsent(J.buildInitialConsent(), {
                        persist: !1,
                        reportClick: !1
                    });
                    this.renderBanner();
        ...
        shouldScanningOverride() {
            return [H.OPT_OUT, H.OPT_OUT_BY_CATEGORY, H.COOKIES_BY_CATEGORY, H.OPT_IN, H.NOTIFY].includes(this.matchedSetting.policy.type) && this.context.getWindow()[c]
        }
        shouldGpcOverride() {
        ...
        logGpcSignal() {
            O.debug("GPC signal: " + this.getGpcSignal())
        }
        findMatchingSetting() {
            const e = this.context.getPathname(),
                ...
                })).reduce((e, t) => L(e.matchResult, t.matchResult) ? e : t, {
                    setting: null,
                    matchResult: E
                });
            I(o.matchResult) && o.setting && this.setMatchingSetting(o.setting.withSanitizedPolicy())
        }
        ...
        setApiBaseUrl(e) {
            /^https:\/\/js-?.{0,3}\.hs-banner(qa)?\.com.*/.test(e) ? this.apiBaseUrl = e : O.error("unsupported base Api url provided.")
        }
        setBannerSettings(e) {
            (e[this.context.getLocation().hostname] || []).forEach(e => this.bannerSettings.push($.fromJS(e)))
        }
        ...
        getCurrentGeoLocation() {
            return new Promise(e => {
                ...
                if (t.includes(r)) {
                    const n = new URLSearchParams(t).get(r);
                    e(n || "")
                } else fetch(this.apiBaseUrl + "/cf-location").then(e => e.text()).then(t => e(t)).catch(() => {
                    O.error("We could not fetch the geolocation.");
                    e("")
                })
            })
        }
        ...
        setConsentCookie() {
            ...
            e !== H.NO_COOKIES && e !== H.COOKIES_WITHOUT_BANNER && e !== H.NOTIFY && this.cookie.set(ne.CATEGORY_PREFERENCE_COOKIE.getName(), this.consent.toCookieString(), {
                daysToExpire: ne.CATEGORY_PREFERENCE_COOKIE.getExpirationDays(),
                path: "/"
            })
        }
        readConsentCookie() {
            const e = this.cookie.get(ne.CATEGORY_PREFERENCE_COOKIE.getName());
            return e ? J.buildFromCookieString(e) : null
        }
        safeCallListener(e, t) {
            try {
                e(t)
            } catch (e) {
                O.error("error calling listener.")
            }
        }
        isGpcBannerDismissCookiePresent() {
            return !!this.cookie.get(ne.GPC_BANNER_DISMISS_COOKIE.getName())
        }
        setGpcBannerDismissCookie() {
            this.cookie.set(ne.GPC_BANNER_DISMISS_COOKIE.getName(), "true", {
                daysToExpire: ne.GPC_BANNER_DISMISS_COOKIE.getExpirationDays(),
                path: "/"
            })
        }
        isNotifyBannerDismissCookiePresent() {
            return !!this.cookie.get(ne.NOTIFY_BANNER_DIMISS_COOKIE.getName())
        }
        setNotifyBannerDismissCookie() {
            this.cookie.set(ne.NOTIFY_BANNER_DIMISS_COOKIE.getName(), "true", {
                daysToExpire: ne.NOTIFY_BANNER_DIMISS_COOKIE.getExpirationDays(),
                path: "/"
            })
        }
        dismissNotifyBanner() {
        ...
        getRenderStyles() {
            try {
                if (this.styleOverrides) {
                    O.debug("using style overrides");
                    return Mt(Yt(this.styleOverrides))
                }
                if (this.matchedSetting) {
                    O.debug("using legacy customization render styles");
                    return Mt(Ft(this.matchedSetting.customizationSettings))
                }
            } catch (e) {
                console.error("unable to utilize style overides", e)
            }
            return ""
        }
        renderGpcBanner() {
            this.bannerParentElement = kt(this.apiBaseUrl, this.context, this.matchedSetting, this.getRenderStyles(), this.dismissGpcBanner.bind(this));
            this.sendViewActivity()
        }
        renderBanner() {
            this.bannerParentElement = Tt(this.apiBaseUrl, this.consent, this.matchedSetting, this.getRenderStyles(), this.context, this.setConsent.bind(this), this.hideBanner.bind(this), this.dismissNotifyBanner.bind(this));
            this.sendViewActivity()
        }
        hideBanner() {
        ...
        showBanner() {
            if (this.matchedSetting.policy.type === H.NO_COOKIES || this.matchedSetting.policy.type === H.COOKIES_WITHOUT_BANNER) return;
        ...
        invoke(e, t) {
            if (!this.publicMethods.includes(e) || !Reflect.has(this, e)) {
                O.debug(`failed to invoke method ${e} of the banner.`);
        ...
        sendClickActivity() {
            ...
            Ot.sendClick(this.apiBaseUrl, t)
        }
        sendViewActivity() {
            if (!this.matchedSetting || this.isRunningInTestMode) return;
            const e = this.getBaseActivityPayload();
            Ot.sendView(this.apiBaseUrl, e)
        }
        getAnalyticsQueue() {
        ...
        trackAction(e) {
            try {
                ...
                O.error("Unable to send analytics tracking event: " + e)
            }
        }
        ...
        revokeCookieConsent() {
            [ne.INITIAL_OPT_IN.getName(), ne.OPT_OUT_COOKIE.getName(), ne.CATEGORY_PREFERENCE_COOKIE.getName(), ne.GPC_BANNER_DISMISS_COOKIE.getName(), ne.NOTIFY_BANNER_DIMISS_COOKIE.getName(), "__hssc", "__hssrc", "__hstc", "__hs_do_not_track", "hubspotutk", "messagesUtk"].forEach(e => this.cookie.remove(e));
    ...
    class Vt {
        constructor(e) {
            ...
            this.banner = new zt(e);
            this.context = e
        }
        queuePushFn(e) {
            try {
                if (!(e && Array.isArray(e) && e.length > 0)) {
                    O.debug("invalid arguments passed to the banner queue.");
                    return !1
                }
                const t = e[0],
                    n = e.slice(1);
                ...
                O.error("There was an error running banner method.")
            }
            return !1
        }
        overrideQueuePush() {
        ...
        run() {
            ...
            if (!e[l]) {
                ...
                this.banner.useGeoLocation ? this.banner.getCurrentGeoLocation().then(e => {
    ...
    var $t = n(3);
    const Kt = e => e.stack ? $t.parse(e.stack).map(e => ({
            filename: e.file,
        ...
        jt = "https://exceptions{{hublet}}.hs-embed-reporting{{env}}.com/outpost",
        Jt = () => "10000000-1000-4000-8000-100000000000".replace(/[018]/g, e => (e ^ crypto.getRandomValues(new Uint8Array(1))[0] & 15 >> e / 4).toString(16)),
        Qt = () => "randomUUID" in crypto ? crypto.randomUUID() : Jt(),
        Zt = (e, t) => {
            const n = "na1" !== e ? "-" + e : "",
                o = "qa" === t ? "qa" : "";
            return jt.replace("{{hublet}}", n).replace("{{env}}", o)
        },
        Xt = (e, t, n, o) => {
        ...
        tn = e => {
            const t = e instanceof Error,
                n = t ? e : new Error(String(e)),
                o = Wt() || "prod",
                i = qt() || "na1",
                s = Xt(n, o, i, {
                    isInstanceOfError: t
                });
            en(`${Zt(i,o)}/cookie-banner-v2/raw/error.gif?url=${s.request.url}\n    &report=${encodeURIComponent(JSON.stringify(s))}`)
        },
        nn = T();

    function on() {
        const e = nn.getWindow();
        if (e[o]) {
            O.info("the cookie banner has already been loaded via another script.");
            return
        }
        e[o] = !0;
        new Vt(nn).run()
    ...
    const an = nn.getDocument();

    function cn() {
        rn();
        an.removeEventListener("DOMContentLoaded", cn)
    }
    "loading" === an.readyState ? an.addEventListener("DOMContentLoaded", cn) : rn()
}]);
