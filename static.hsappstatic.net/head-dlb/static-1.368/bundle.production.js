! function(e) {
    ...
    i.default.define("raven-hubspot/configure", [], () => {
        const e = r(8)
        return e.default || e
    })
    i.default.define("PortalIdParser", [], () => {
        const e = r(10)
        return e.default || e
    })
    i.default.define("enviro", [], () => {
        const e = r(9)
        return e.default || e
    })
    ...
    ((r = "undefined" != typeof window && null !== window ? window : "undefined" != typeof global && null !== global ? global : this).hns = r.hns2 = function(e, t) {
            ...
            for (var d in t)
                if (t.hasOwnProperty(d))
                    if ("object" == typeof o[d]) {
                        ...
                        for (; i.length > 0;) {
                            a = i.shift()
                            for (var p in a.qSource) a.qSource.hasOwnProperty(p) && ("object" != typeof a.qSource[p] || "object" != typeof a.qTarget[p] || a.qSource[p] && void 0 !== a.qSource[p].classList && void 0 !== a.qSource[p].nodeType ? a.qTarget[p] = a.qSource[p] : a.qSource[p] !== a.qTarget[p] && i.push({
                                qSource: a.qSource[p],
                                qTarget: a.qTarget[p]
                            }))
                        }
        ...
        function d(r, n) {
            for (var o, i, a = n.deps, s = n.depsDict, l = a.length, u = []; l--;) {
                i = a[l]
    ...
    const i = () => window.newrelic,
        a = e => null === e ? "Null" : void 0 === e ? "Undefined" : Object.prototype.toString.call(e).slice(8, -1),
        s = e => {
            const t = r(5),
                o = (0, n.getUniqueKey)(),
                s = a(e),
        ...
        return function e(t, r, o) {
            ...
            3: [function(e, t, r) {
                (function(r) {
                    ...
                    var D = "undefined" != typeof window ? window : void 0 !== r ? r : "undefined" != typeof self ? self : {},
                        U = D.document,
                        P = D.navigator
                    ...
                    N.prototype = {
                        ...
                        config: function(e, t) {
                            ...
                            var i = {
                                ...
                                a = o.autoBreadcrumbs "[object Object]" === {}.toString.call(a) ? a = g(i, a) : !1 !== a && (a = i)
                            o.autoBreadcrumbs = a
                            var s = {
                                    tryCatch: !0
                                },
                                l = o.instrument "[object Object]" === {}.toString.call(l) ? l = g(s, l) : !1 !== l && (l = s)
                            o.instrument = l
                        ...
                        showReportDialog: function(e) {
                            if (U) {
                                ...
                                l.async = !0
                                l.src = s + "/api/embed/error-page/" + o;
                        ...
                        _instrumentTryCatch: function() {
                            ...
                            function o(r) {
                                ...
                                if (o && o.hasOwnProperty && o.hasOwnProperty("addEventListener")) {
                                    O(o, "addEventListener", (function(t) {
                                        return function(o, i, a, s) {
                                            ...
                                            return t.call(this, o, e.wrap(i, void 0, l), a, s)
                                        }
                                    }), t)
                                    O(o, "removeEventListener", (function(e) {
                            ...
                            O(D, "setTimeout", r, t)
                            O(D, "setInterval", r, t)
                            D.requestAnimationFrame && O(D, "requestAnimationFrame", (function(t) {
                                return function(r) {
                                    return t(e.wrap(r))
                                }
                            }), t)
                        ...
                        _instrumentBreadcrumbs: function() {
                            ...
                            if (t.xhr && "XMLHttpRequest" in D) {
                                ...
                                O(o, "open", (function(t) {
                                    return function(r, n) {
                                        d(n) && -1 === n.indexOf(e._globalKey) && (this.__raven_xhr = {
                                            method: r,
                                            url: n,
                                            status_code: null
                                        })
                                ...
                                O(o, "send", (function(t) {
                                    return function(r) {
                                        ...
                                        "onreadystatechange" in o && f(o.onreadystatechange) ? O(o, "onreadystatechange", (function(t) {
                            ...
                            t.xhr && "fetch" in D && O(D, "fetch", (function(t) {
                                return function(r, n) {
                                    for (var o = new Array(arguments.length), i = 0; i < o.length; ++i) o[i] = arguments[i]
                                    var a, s = o[0],
                                        l = "GET"
                            ...
                            if (t.dom && this._hasDocument)
                                if (U.addEventListener) {
                                    U.addEventListener("click", e._breadcrumbEventHandler("click"), !1)
                                    U.addEventListener("keypress", e._keypressEventHandler(), !1)
                                } else {
                                    U.attachEvent("onclick", e._breadcrumbEventHandler("click"))
                                    U.attachEvent("onkeypress", e._keypressEventHandler())
                                }
                            var i = D.chrome,
                                a = !(i && i.app && i.app.runtime) && D.history && history.pushState && history.replaceState
                            if (t.location && a) {
                                var s = D.onpopstate
                        ...
                        _trimPacket: function(e) {
                            ...
                            var n = e.request
                            if (n) {
                                n.url && (n.url = b(n.url, this._globalOptions.maxUrlLength))
                                n.Referer && (n.Referer = b(n.Referer, this._globalOptions.maxUrlLength))
                            }
                        ...
                        _trimBreadcrumbs: function(e) {
                            for (var t, r, n, o = ["to", "from", "url"], i = 0; i < e.values.length; ++i)
                                if ((r = e.values[i]).hasOwnProperty("data") && l(r.data) && !v(r.data)) {
                                    n = g({}, r.data)
                                    for (var a = 0; a < o.length; ++a) {
                                        t = o[a]
                                        n.hasOwnProperty(t) && n[t] && (n[t] = b(n[t], this._globalOptions.maxUrlLength))
                                    }
                                    e.values[i].data = n
                                }
                        },
                        _getHttpData: function() {
                            if (this._hasNavigator || this._hasDocument) {
                                var e = {}
                                this._hasNavigator && P.userAgent && (e.headers = {
                                    "User-Agent": navigator.userAgent
                                })
                                if (this._hasDocument) {
                                    U.location && U.location.href && (e.url = U.location.href)
                                    if (U.referrer) {
                                        e.headers || (e.headers = {})
                        ...
                        _isRepeatData: function(e) {
                            ...
                            return !(!t || e.message !== t.message || e.culprit !== t.culprit) && (e.stacktrace || t.stacktrace ? k(e.stacktrace, t.stacktrace) : !e.exception && !t.exception || E(e.exception, t.exception))
                        },
                        ...
                        _send: function(e) {
                            ...
                            e && !p(e) && (f(t.shouldSendCallback) && !t.shouldSendCallback(e) || (this._shouldBackoff() ? this._logDebug("warn", "Raven dropped error due to backoff: ", e) : "number" == typeof t.sampleRate ? Math.random() < t.sampleRate && this._sendProcessedPayload(e) : this._sendProcessedPayload(e)))
                        },
                        _getUuid: function() {
                            return w()
                        },
            ...
            5: [function(e, t, r) {
                (function(e) {
                    ...
                    function w(e) {
                        for (var t, r = 5, n = 80, o = [], i = 0, a = 0, s = " > ", l = s.length; e && i++ < r && !("html" === (t = x(e)) || i > 1 && a + o.length * l + t.length >= n);) {
                            o.push(t)
                            a += t.length
                            e = e.parentNode
                        }
                    ...
                    function k(e, t) {
                        ...
                        e = e.values[0]
                        t = t.values[0]
                        return e.type === t.type && e.value === t.value && S(e.stacktrace, t.stacktrace)
                    }
            ...
            6: [function(e, t, r) {
                (function(r) {
                    ...
                    o.report = function() {
                        ...
                        function v(t, r, i, a, c) {
                            if (d) {
                                o.computeStackTrace.augmentStackTraceWithInitialElement(d, r, i, t)
                                y()
                    ...
                    o.computeStackTrace = function() {
                        function e(e) {
                            if (void 0 !== e.stack && e.stack) {
                                for (var t, r, n, o = /^\s*at (.*?) ?\(((?:file|https?|blob|chrome-extension|native|eval|webpack|bpm|<anonymous>|[a-z]:|\/).*?)(?::(\d+))?(?::(\d+))?\)?\s*$/i, i = /^\s*(.*?)(?:\((.*?)\))?(?:^|@)((?:file|https?|blob|chrome|webpack|bpm|resource|\[native).*?|[^@]*bundle)(?::(\d+))?(?::(\d+))?\s*$/i, a = /^\s*at (?:((?:\[object object\])?.+) )?\(?((?:file|ms-appx|https?|webpack|bpm|blob):.*?):(\d+)(?::(\d+))?\)?\s*$/i, l = /(\S+) line (\d+)(?: > eval line \d+)* > eval/i, c = /\((\S*)(?::(\d+))(?::(\d+))\)/, f = e.stack.split("\n"), d = [], p = (/^(.*) is undefined$/.exec(e.message), 0), h = f.length; p < h; ++p) {
                                    if (r = o.exec(f[p])) {
                        ...
                        function r(e, i) {
                            for (var a, l, c = /function\s+([_$a-zA-Z\xA0-\uFFFF][_$a-zA-Z0-9\xA0-\uFFFF]*)?\s*\(/i, f = [], d = {}, p = !1, h = r.caller; h && !p; h = h.caller)
                                if (h !== n && h !== o.report) {
                                    l = {
                                        url: null,
                                        func: s,
            ...
            7: [function(e, t, r) {
                ...
                function a(e, t) {
                    ...
                    return function(a, s) {
                        if (r.length > 0) {
                            var l = n(r, this) ~l ? r.splice(l + 1) : r.push(this) ~l ? o.splice(l, 1 / 0, a) : o.push(a) ~n(r, s) && (s = t.call(this, a, s))
                        } else r.push(s)
    ...
    function f(e, t = {}) {
        ...
        u((t = Object.assign({}, n, {}, t, {
            ignoreErrors: [...n.ignoreErrors, ...l]
        })).ignoreErrors)
        const f = o.default.getShort("sentry")
        let d
        try {
            d = !!(document && document.cookie && document.cookie.includes("hs_selenium"))
        } catch (e) {
            d = !1
        }
        a.default.config(e, {
            ...
            tags: Object.assign({
                env: f,
                project: r && r.currentProject,
                portalId: i.default.get(),
            ...
            dataCallback: c(t.dataCallback),
            shouldSendCallback: t.shouldSendCallback || (() => !0)
        }).install() !o.default.debug("sentry") && o.default.deployed("sentry") || (a.default.debug = !0)
        o.default.deployed("sentry") || a.default.setTransport(({
            onSuccess: e
        }) => {
            e()
        })
    ...
    window.setInterval = function(e, ...t) {
        "function" != typeof e && a.default.captureException(new Error("Implied eval. Only a function should be passed as first arg of setInterval."))
        return d(e, ...t)
    }
    const p = window.setTimeout
    window.setTimeout = function(e, ...t) {
        "function" != typeof e && a.default.captureException(new Error("Implied eval. Only a function should be passed as first arg of setTimeout."))
        return p(e, ...t)
    }
    e.exports = t.default
}, function(e, t, r) {
    ...
    var s = function e(t) {
        const r = new RegExp(`^(?!local|test|selenium)(.*\\.)?(${Object.entries(a).map(([e,t])=>`(?:${t})(qa)?\\.${e}`).join("|")}|(?:connect)\\.com|(?:connect)(qa)\\.co)$`).test(t.hostname),
            o = new RegExp(Object.entries(a).map(([e, t]) => `(?:${t})qa\\.${e}`).join("|") + "|(?:connect)qa\\.co"),
            i = new RegExp(`^(?:${n.join("|")})-(.*).(?:hubspot|hubteam)(?:qa)?.com`),
        ...
        return {
            createEnviro: e,
            debug: (e, t = !1) => {
                let r "string" == typeof e && (r = c(e.toUpperCase() + "_DEBUG"))
                null == r && (r = c("DEBUG"))
                return null == r ? t : r
            },
            denormalize: g,
            deployed: e => {
                let t "string" == typeof e && (t = c(e.toUpperCase() + "_DEPLOYED"))
                null == t && (t = c("DEPLOYED"))
                return null == t ? r : !!t
            },
            enabled: (e, t = !1) => {
                let r = c(e.toUpperCase() + "_ENABLED")
